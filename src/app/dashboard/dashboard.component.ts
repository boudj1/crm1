...
import {Chart,ChartType,registerables,
  ArcElement,
  LineElement,
  BarElement,
  PointElement,
...
export class DashboardComponent implements OnInit {
  ...
  events : any[] = [];
  event : any[] = [];
  constructor( public db : AngularFireDatabase,public crudApi : ClientService,) {
  ...
  s.snapshotChanges().subscribe(data => {
    ...
    this.myChartData = new Chart(this.ctx, (config) as any) ;
    ...
    var valueRef = this.db.database.ref('listclient');
    valueRef.on('child_added', (snapshot) => {
        var capitale = snapshot.val().capitale;
        var NomClient = snapshot.val().NomClient
        this.addData(myChart, NomClient, capitale);
    });
  }
